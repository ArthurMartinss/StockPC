...
class UsuarioDAO{
    ...
    function inserir($usuario){
        $result = $this->con->query("INSERT INTO usuarios (cpf,cnpj,data_nasc,genero,celular,email,senha,nome,razao_social,tributo,nome_fantasia,telefone_empresa,cep,logradouro,numero,complemento,bairro,cidade,estado,referencia) VALUES ('" . $usuario->get_cpf() . "', '" . $usuario->get_cnpj() . "', '" . $usuario->get_data_nasc() . "', '" . $usuario->get_genero() . "', '" . $usuario->get_celular() . "', '" . $usuario->get_email() . "', '" . $usuario->get_senha() . "', '" . $usuario->get_nome() . "', '" . $usuario->get_razao_social() . "', '" . $usuario->get_tributo() . "' , '" . $usuario->get_nome_fantasia() . "', '" . $usuario->get_telefone_empresa() . "', '" . $usuario->get_cep() . "', '" . $usuario->get_logradouro() . "', '" . $usuario->get_numero() . "', '" . $usuario->get_complemento() . "', '" . $usuario->get_bairro() . "', '" . $usuario->get_cidade() . "', '" . $usuario->get_estado() . "', '" . $usuario->get_referencia() . "')");
    ...
    function alterar($usuario){
        $result = $this->con->query("UPDATE usuarios SET cpf = '" . $usuario->get_cpf() . "', cnpj = '" . $usuario->get_cnpj() . "', data_nasc = '" . $usuario->get_data_nasc() . "', genero = '" . $usuario->get_genero() . "', celular = '" . $usuario->get_celular() . "', email = '" . $usuario->get_email() . "', senha = '" . $usuario->get_senha() . "', nome = '" . $usuario->get_nome() . "', razao_social = '" . $usuario->get_razao_social() . "', tributo = '" . $usuario->get_tributo() . "', nome_fantasia = '" . $usuario->get_nome_fantasia() . "', telefone_empresa = '" . $usuario->get_telefone_empresa() . "', cep = '" . $usuario->get_cep() . "', logradouro = '" . $usuario->get_logradouro() . "', numero = '" . $usuario->get_numero() . "', complemento = '" . $usuario->get_complemento() . "', bairro = '" . $usuario->get_bairro() . "', cidade = '" . $usuario->get_cidade() . "', estado ='" . $usuario->get_estado() . "', referencia = '" . $usuario->get_referencia() . "' WHERE id_usuario = " . $usuario->get_id_usuario());
        if ($result->rowCount() > 0){
            return true;
        }
        else{
